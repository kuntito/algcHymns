...
object AlgcApiClient {
    // TODO replace with stable base url
    private const val BASE_URL = "https://19af-105-119-8-90.ngrok-free.app"
    ...
    val algcApi: AlgcApiService = retrofit.create(
        AlgcApiService::class.java
    )
}